...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    // AÇÃO: ATUALIZAR (Incluindo plano_interesse)
...
// 3. Filtro de Busca (Ajustado para buscar também no plano)
...
<html lang="pt-br">
<head>
    <!-- Estilos mantidos conforme seu código -->
    <meta charset="UTF-8">
    ...
    <section class="search-container" style="background: var(--card); border: 1px solid var(--border); padding: 25px; border-radius: 20px; margin-bottom: 30px;">
        <form method="GET" style="display: flex; gap: 15px; align-items: flex-end;">
            <div class="input-group" style="margin-bottom:0;">
                <label>Busca rápida (Nome, Login, E-mail ou Plano)</label>
    ...
    <div style="background:var(--card); width:95%; max-width:600px; padding:30px; border-radius:24px; border:1px solid var(--border);">
        ...
        <form action="gestao_membros.php" method="POST">
            ...
            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:15px;">
                ...
                <div class="input-group"><label>Senha (Vazio p/ manter)</label><input type="password" name="senha" placeholder="Nova senha..."></div>
                ...
                <div class="input-group">
                    <label>Plano de Interesse (Solicitado)</label>
